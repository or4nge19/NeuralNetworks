...
* Fogelman Soulie, F., Robert, Y., & Tchuente, M. (1985). Convergence in Asymmetric Hopfield Networks.
* Michel, A. N., Farrell, J. A., & Porod, W. (1989). On the stability, storage capacity, and design of nonlinear continuous neural networks.

The implementation uses:
* Asymmetric weight matrix decomposition (W = A + S) for convergence analysis
* Sequential update scheme for asymmetric networks
* Simplified potential function adapted for discrete-time updates
* Custom updateStateAsym definition for asymmetric networks
* Standard bounding technique for potential function proofs
-/
